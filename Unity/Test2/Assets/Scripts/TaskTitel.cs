...
public class TaskTitel : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            textMeshPRO.text = "Aufgabe Steambot Teil 1/2";
        }else if (TaskManager.Instance.task == "Nerfgun")
        {
            textMeshPRO.text = "Aufgabe Nerfgun Teil 1/2";
        }
        else if (TaskManager.Instance.task == "Snake")
        {
            textMeshPRO.text = "Aufgabe Snake Teil 1/2";
        }
        else if (TaskManager.Instance.task == "Ferry")
        {
            textMeshPRO.text = "Aufgabe Ferry Teil 1/2";
        }
        else if (TaskManager.Instance.task == "Dog")
        {
            textMeshPRO.text = "Aufgabe Dog Teil 1/2";
        }
